      ...
      745: (e, t) => {
        ...
        class r {
          ...
          static encodeAndInsert(e, t, n = 1) {
            const o = r.encode(e);
            return `${t.slice(0, n)}${o}${t.slice(n)}`;
          }
        ...
        class a {
          static randomizePhoneNumberIfNecessary(e) {
            ...
            return e.includes("phone=")
              ? a.withReplaceQueryParam(e, "phone", o)
              : e.includes("wa.me")
          ...
          static insertAdIdInWppUrl(e, t) {
            var r;
            const n =
                null !== (r = a.getQueryParams(e).get("text")) && void 0 !== r
                  ? r
                  : "Olá",
              i = t.replace(/[^0-9]/g, ""),
              l = o.UnicodeHasher.removeAllEncodedChars(n),
              s = o.UnicodeHasher.encodeAndInsert(i, l);
            return a.withReplaceQueryParam(e, "text", s);
          }
          static getAdId(e) {
            var t;
            const r =
  ...
  (() => {
    ...
    class u {
      static addUtmParametersToUrl(e) {
        ...
        const a = u.urlParametersWithoutDuplicates(o),
          l = u.simplifyParametersIfNecessary(t, a),
      ...
      static getUtmParameters() {
        ...
        function r(e) {
          ...
          if (!n) return "";
          const o = localStorage.getItem(m(e));
        ...
        const o = r("utm_term"),
            ...
            const t = (function () {
              ...
              const r =
                null !== (e = localStorage.getItem("lead")) && void 0 !== e
                  ? e
                  : localStorage.getItem("lead-google");
              if (!r) return null;
              const n = JSON.parse(r);
              return null !== (t = null == n ? void 0 : n._id) && void 0 !== t
                ? t
                : null;
            })();
          ...
          v = r("cid");
        i.isCartpanda
          ? p.set("cid", v || Math.round(1e11 * Math.random()).toString())
          : v && p.set("cid", v),
          null != d && "" !== d && p.set("gclid", d),
          p.set("utm_source", u),
          p.set("utm_campaign", c),
          p.set("utm_medium", s),
          p.set("utm_content", l),
          p.set("utm_term", o),
          i.isClickBank
            ? (p.set("aff_sub1", a.UrlRebuilder.removeSpecialCharacteres(u)),
              p.set(
                "aff_sub2",
                a.UrlRebuilder.removeSpecialCharacteres(c).replace(
                  /\|(?=\d{10,}$)(?!.*\|)/,
                  "cKBk"
                )
              ),
              p.set(
                "aff_sub3",
                a.UrlRebuilder.removeSpecialCharacteres(s).replace(
                  /\|(?=\d{10,}$)(?!.*\|)/,
                  "cKBk"
                )
              ),
              p.set(
                "aff_sub4",
                a.UrlRebuilder.removeSpecialCharacteres(l).replace(
                  /\|(?=\d{10,}$)(?!.*\|)/,
                  "cKBk"
                )
              ),
              p.set("aff_sub5", a.UrlRebuilder.removeSpecialCharacteres(o)))
            : i.preventSubIds ||
              (p.set("subid", a.UrlRebuilder.removeSpecialCharacteres(u)),
              p.set("sid2", a.UrlRebuilder.removeSpecialCharacteres(c)),
              p.set("subid2", a.UrlRebuilder.removeSpecialCharacteres(c)),
              p.set("subid3", a.UrlRebuilder.removeSpecialCharacteres(s)),
              p.set("subid4", a.UrlRebuilder.removeSpecialCharacteres(l)),
              p.set("subid5", a.UrlRebuilder.removeSpecialCharacteres(c)));
        const f = r("src");
        null != f && "" !== f && p.set("src", f);
        const h = [u, c, s, l, o],
          g = h.every((e) => "" === e),
          S = r("xcod"),
          y = r("sck");
        if (i.preventXcodSck) S && p.set("xcod", S), y && p.set("sck", y);
        else {
          const t = n(h, e),
            r = (function (e, t, r) {
              if (e.length <= 255) return e;
              const o = Math.floor(18.8);
              function a(e, t, r) {
                function n(e) {
                ...
                return `${n(
                  1 === i.length ? i[0] : i.slice(0, -1).join(a)
                )}${a}${l}`;
              }
              const [i, l, s, c, u] = e.split(r);
              return n(
                [a(i, !0, "jLj"), a(l, !0), a(s, !0), a(c, !0), a(u, !1)],
                r
              );
            })(g ? ("" !== S ? S : f) : t, 0, e);
          p.set("xcod", r), p.set("sck", r);
        }
        const w = t.get("fbclid");
        null != w && "" !== w && p.set("fbclid", w);
        const b = r("utm_id");
        return (
          b && p.set("utm_id", b),
          (() => {
            const e = (e) => null == e || "" === e,
              ...
              s = r("src"),
              c = p.get("fbclid");
            return e(t) && e(n) && e(o) && e(a) && e(i) && e(l) && e(s) && e(c);
    ...
    function p() {
        ...
        document.querySelectorAll("a").forEach((t) => {
          ...
          if (
            ...
            if (
              ...
              return (
                (t.href = a.UrlRebuilder.randomizePhoneNumberIfNecessary(
                  t.href
                )),
                void (t.href = a.UrlRebuilder.insertAdIdInWppUrl(
                  t.href,
                  null != r ? r : ""
                ))
              );
            ...
            (t.href = u.addUtmParametersToUrl(t.href)),
              i.replaceLinks &&
                (function (e, t) {
                  var r, n;
        ...
        document.querySelectorAll("form").forEach((t) => {
          ...
          (e && d.every((e) => t.action.includes(e))) ||
            (null === (r = null == i ? void 0 : i.ignoreClasses) || void 0 === r
              ? void 0
              : r.some((e) => t.classList.contains(e))) ||
            ((t.action = u.addUtmParametersToUrl(t.action)),
            u.getUtmParameters().forEach((e, r) => {
      ...
      const r = (function () {
        var e, t, r, n, o, a, l, s, c, u, d, m, p, v, f, h, g, S, y, w, b, U;
        const { fixShopifyTheme: _ } = i,
          R =
            null !==
              ...
              : n.schema_name,
          P =
            null !== (o = null == R ? void 0 : R.includes("Dropmeta")) &&
            void 0 !== o &&
            o,
          L =
            null !== (a = null == R ? void 0 : R.includes("Warehouse")) &&
            void 0 !== a &&
            a,
          E =
          ...
          I =
            ...
            s,
          A =
            null !== (c = null == R ? void 0 : R.includes("Waresabino")) &&
            void 0 !== c &&
            c,
          k =
            null !== (u = null == R ? void 0 : R.includes("Dawn")) &&
            void 0 !== u &&
            u,
          x =
          ...
          q =
            ...
            S,
          M =
            null !== (y = null == R ? void 0 : R.includes("WART")) &&
            void 0 !== y &&
            y,
          W =
        ...
        r ||
          ...
          (function () {
            ...
            new MutationObserver((r, n) => {
              ...
              r.some((e) => Array.from(e.addedNodes).some(o)) || (e(!0), t(!0));
          ...
          i.ignoreAllIframes ||
            ...
            document.querySelectorAll("iframe").forEach((e) => {
              ...
              Object.values(s).some((t) => e.src.includes(t)) ||
                ...
                (e.src = u.addUtmParametersToUrl(e.src));
            }));
    }
    const v = () => {
      p(),
